const CACHE='ambika-v3-staff-1';
const ASSETS=['./','./index.html','./style.css','./script.js','./manifest.json','./assets/balaji-vaidya.jpg','./assets/dnyanoba-vaidya.jpg','./assets/nikhil-vaidya.jpg'];
